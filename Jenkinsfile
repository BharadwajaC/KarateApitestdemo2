        ...
        stage('Build Docker image'){
            steps{
                script{
                    ...
                    sh 'docker copy karateapidemo2:/home/karateuser/KarateApitestdemo2/target/karate-reports/karate-summary.html /home/bharadwaja/karatelogs/karate-summary.html'
                }
            }
        }
    }
